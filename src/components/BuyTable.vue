<template>
    <div class="buytable">
        <table class="buytable__table w-full">
            <thead class="buytable__head pt-6 pb-2">
            ...
            <tbody class="buytable__body border-t border-t-pastel">
                <tr
                    v-for="user in users"
                    :key="user.index"
                    class="buytable__row border-b border-b-pastel"
                >
                    <td
                        class="buytable__user pl-8 py-2 flex items-center gap-3 border-r border-r-pastel"
                    >
                        <img
                            :src="user.img"
                    ...
                    <td
                        class="buytable__sum py-3 px-6 text-right self-center border-r border-r-pastel"
                    >
                        $ {{ user.sum }}
                    </td>
                    <td
                        class="buytable__rating py-3 border-r border-r-pastel flex gap-2 pl-6"
                    >
                    ...
                    <td class="buytable__rep py-3 flex gap-3 items-center pl-6">
                        <div
